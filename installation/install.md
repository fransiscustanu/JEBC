...
* Install and configure a [database server](https://www.cloudera.com/documentation/enterprise/5-14-x/topics/cm_ig_installing_configuring_dbs.html)
...
## <center> Path B install using CM 5.14.x

[The full rundown is
here](https://www.cloudera.com/documentation/enterprise/5-14-x/topics/cm_ig_install_path_b.html).
